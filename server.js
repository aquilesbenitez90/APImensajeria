...
- LARGO (CRÍTICO — la página 1 tiene que RESPIRAR, no ser un muro de texto; MENOS ES MÁS): lead = 1 oración CORTA (máx ~22 palabras); proof = 1 oración; cada desc del ICP = una FRASE TELEGRÁFICA de máx ~14 palabras (frase nominal, sin oraciones largas con subordinadas, sin relleno: ej. "VP/Director de Operaciones o RobOps Lead", NO un párrafo explicativo); "Señal de compra" y "Pain primario" = media oración cada una (máx ~14 palabras); cada bullet de context = máx ~16 palabras; cada prioridad = "Alta/Media:" + frase de máx ~12 palabras. Cortá TODA palabra que no aporte; preferí frases nominales a oraciones completas. El objetivo es una página que se lea de un vistazo, no que se lea entera.
...
## Output — SOLO JSON (sin texto ni markdown alrededor)
{
  ...
  "lead": "1 oración CORTA (máx ~22 palabras) anclando el proof point REAL del cliente.",
